...
| -------------------------- | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Show and Movie Lists       | TXT, HTML                 | Whenever a show is added or removed from the library TV Rename will update the show list file. The HTML version is a pretty output designed to be printed and viewable by users to help decide what to watch |
| Missing Episodes or Movies | XML, CSV                  | Whenever a full scan is executed TV Rename outputs details of all missing episodes.                                                                                                                          |
...
Further information can be found [**here** ](../../the-manual/preferences.md#the-automatic-export-tab-1)and **** [**here**](../../the-manual/preferences.md#library-export).
