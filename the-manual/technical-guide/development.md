...
* For the longer term you can visit the “[Roadmap](https://github.com/TV-Rename/tvrename/milestones?direction=asc\&sort=due\_date\&state=open)” which lists the proposed Milestones (a high level view of what's planned for when).
