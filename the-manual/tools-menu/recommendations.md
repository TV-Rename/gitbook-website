---
description: Get some new ideas about shows and movies to watch
---
...
1. Use the list view on the left to filter and sort the possible recommendations. (right click on the column headers for options)
2. Enter the preferences to adjust the weightings provided to the 4 categories of suggestions (above)
3. Review a preview of the recommended show/movie
